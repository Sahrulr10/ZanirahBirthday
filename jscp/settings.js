...
let settings = {
    ...
    sequence: 'HAPPY|BIRTHDAY|TO|ZANIRAH|❤',
    ...
    pages: [
        ...
        { 
            ...
            content: 'Happy Birthday iraa 🤍' 
        },
        { 
            image: './image/photos/b4.png', // Menggantikan 8u5tf7.png (Index 3)
        },
...
setTimeout(() => {
    ...
    // Tampilkan tombol Start, tunggu user klik
    ...
    if (startOverlay && startButton) {
        ...
        startButton.addEventListener('click', () => {
            ...
            // Mainkan musik — sah karena dipicu klik asli user
            if (typeof toggleMusic === 'function') {
                toggleMusic();
            }

            // Baru jalankan pengalaman website-nya
        ...
        // fallback kalau overlay nggak ketemu
        if (typeof tryStartWebsiteWhenLandscape === 'function') {
            tryStartWebsiteWhenLandscape();
        } else if (typeof startWebsite === 'function') {
            startWebsite();
